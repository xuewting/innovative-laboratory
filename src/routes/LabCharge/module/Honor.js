...
//打开论文模块
  showPaperModal = (ptitle,magazine,author,ptime) => {
    this.setState({
      visible1: true,
      ptitle:ptitle,
      magazine:magazine,
       ...
       render:(text, record, index)=>{
        return(
          <Row>
            <Col span={12}>{record.time}</Col>
            <Col span={6}>
              <Button onClick={this.showPaperModal.bind(this,record.title,record.magazine,record.author,record.time)}>修改</Button>
              </Col>
            <Col span={6}><Button type='danger'>删除</Button></Col>
          </Row>
        )
          ...
          <div className="ho_con">
            ...
            <div className="competition" style={{ marginBottom: 20 }}>
              ...
              <div className="com_foot">
                <Button type='primary' onClick={this.showCompetitionModal.bind(this,'','','','','','')}><i className='fa fa-plus'></i> 添加</Button>
                <Modal
                  title="竞赛成果"
                ...
                >
                  <Row style={{ marginBottom: 10 }}>
                    ...
                    <Col span={18}><Input placeholder='输入作品的名称' value={this.state.ctitle} onChange={(e)=>this.changeCValue(1,e.target.value)}></Input></Col>
                  </Row>
                  <Row style={{ marginBottom: 10 }}>
                  ...
                  <Row style={{ marginBottom: 10 }}>
                    ...
                    <Col span={18}><Input placeholder='输入获得的成果（一等奖，第一名...）' value={this.state.reward} onChange={(e)=>this.changeCValue(3,e.target.value)}></Input></Col>
                  </Row>
                  <Row style={{ marginBottom: 10 }}>
                    <Col span={6}><h3>参与学生：</h3></Col>
                    <Col span={18}><Input placeholder='输入参与的学生姓名（中间用逗号隔开）' value={this.state.students} onChange={(e)=>this.changeCValue(4,e.target.value)}></Input></Col>
                  </Row>
                  <Row style={{ marginBottom: 10 }}>
                    <Col span={6}><h3>指导老师：</h3></Col>
                    <Col span={18}><Input placeholder='输入指导老师姓名（中间用逗号隔开）' value={this.state.teacher} onChange={(e)=>this.changeCValue(5,e.target.value)}></Input></Col>
                  </Row>
                  <Row style={{ marginBottom: 10 }}>
            ...
            <div className="paper">
              ...
              <div className="pa_foot">
                <Button type='primary' onClick={this.showPaperModal.bind(this,'','','','')}><i className='fa fa-plus'></i> 添加</Button>
                <Modal
                  title="论文发表"
                ...
                >
                 <Row style={{ marginBottom: 10 }}>
                    ...
                    <Col span={18}><Input placeholder='输入论文标题' value={this.state.ptitle} onChange={(e)=>this.changePValue(1,e.target.value)}></Input></Col>
                  </Row>
                   <Row style={{ marginBottom: 10 }}>
                    <Col span={6}><h3>期刊：</h3></Col>
                    <Col span={18}><Input placeholder='输入论文发表的期刊' value={this.state.magazine} onChange={(e)=>this.changePValue(2,e.target.value)}></Input></Col>
                  </Row>
                   <Row style={{ marginBottom: 10 }}>
                    <Col span={6}><h3>作者：</h3></Col>
                    <Col span={18}><Input placeholder='输入论文的作者（用逗号隔开）' value={this.state.author} onChange={(e)=>this.changePValue(3,e.target.value)}></Input></Col>
                  </Row>
                   <Row style={{ marginBottom: 10 }}>
