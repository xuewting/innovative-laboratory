    ...
    return (
      <div style={{ paddingTop: 20, paddingRight: 15 }}>
        ...
        >
          ...
          <Row style={{ fontSize:16, marginBottom:10 }}>
            <Col span={6}>物品编号：</Col>
            <Col span={18}><Input placeholder='请输入物品的编号' value={bh} onChange={(e) => this.changeValue(2, e.target.value)} /></Col>
          </Row>
          <Row style={{ fontSize:16, marginBottom:10 }}>
            <Col span={6}>型号：</Col>
            <Col span={18}><Input placeholder='请输入物品的型号' value={xh} onChange={(e) => this.changeValue(3, e.target.value)} /></Col>
          </Row>
          <Row style={{ fontSize:16, marginBottom:10 }}>
            <Col span={6}>物品状态：</Col>
            <Col span={18}>
